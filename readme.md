...
- 1. Hardware peripheral triggers the DMA transfer by sending a request message for transfer to the DMA Controller 2. DMA Performs Load Store operation 3. DMA Acknowledges after transfer is done 4. 
