...
### Internal Peripheral Interrupt - USED FOR INTERRUPTS GENERATED BY INTERNAL CIRCUITRY
- The peripheral itself raises an internal request to NVIC.
- In the software the corresponding NVIC line must be enabled.
